...
func getSamlAuthToken(vcdCli *VCDClient, user, pass, samlEntityId, authEndpoint, org string) (string, error) {
	...
	req.Header.Add("Content-XmlType", types.SoapXML)
	...
	<s:Header>
		...
		<o:Security s:mustUnderstand="1"
			...
			<o:UsernameToken>
				...
				<o:Password o:XmlType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText">` + password + `</o:Password>
			</o:UsernameToken>
		</o:Security>
	</s:Header>
	<s:Body>
